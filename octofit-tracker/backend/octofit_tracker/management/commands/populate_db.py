...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Clear existing data in correct order to avoid FK issues and ObjectIdField unhashable bug
        ...
        Workout.objects.create(name='Justice Strength', description='Strength training for justice league', suggested_for='DC')
